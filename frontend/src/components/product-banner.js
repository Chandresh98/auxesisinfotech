               ...
               <div className="product-banner-outer">
                  <div className="row">
                     ...
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0 pb-4 mb-5">
                           <li class="breadcrumb-item"><a href="/shop">Catalog</a></li>
                           <li class="breadcrumb-item">Product</li>
                           <li class="breadcrumb-item active" aria-current="page">{product?.attributes?.Name}</li>
                        </ol>
                     </nav>
                     </div>
                           ...
                           <div className="p-banner-contet" >
                              ...
                              <div className="accessories mt-4">
                                 ...
                                 <div className="form-check checkinput">
                                    <input type="checkbox" id="" placeholder="S" />
                                    <label>{product?.attributes?.accessories?.attributes?.Accessories_Name} $72/mo.</label>
                                 </div>
                              </div>
                              {/* {Products.map((accessories) => ( 
                                           <div className="form-check checkinput">
                                           <input type="checkbox" id="" placeholder="S" />
                                           <label>{accessories.attributes.Accessories_Name} $72/mo.</label>
                                        </div>
                                       ))} */}
                              <div className="onetimedeposite">
                                 <div className="form-check">
                                    <input className="form-check-input" type="radio" name="deposite" id="deposite" value="deposite" />
                                    <label className="form-check-label" for="deposite">
